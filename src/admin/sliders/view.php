...
$image = $slider->getMedia($_GET['id']);
$slider = $slider->getById($_GET['id']); //                                          sql injection
// print_r($slider);
// die();
if ($slider === false) {
        ...
        <div class="card card-default">
            ...
            <div class="card-body row">
                <form class="col-12 col-lg-8" method="POST" action="update.php" enctype="multipart/form-data">
                    ...
                    ?>
                    <input type="hidden" name="id" value="<?= $slider['hero_slider_id'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="order" name="order" value="<?= $slider['slider_order'] ?>" min=1 max=100 required>
                    </div>
                    <div class="form-group">
                        ...
                        <ul class="list-unstyled list-inline">
                            <li class="d-inline-block mr-3">
                                <label class="control outlined control-radio radio-success">published
                                    <input type="radio" name="status" value="published" <?php if ($slider['status'] == 'published') echo 'checked="checked"'; ?> required>
                            ...
                            <li class="d-inline-block mr-3">
                                <label class="control outlined control-radio radio-danger">unpublished
                                    <input type="radio" name="status" value="unpublished" <?php if ($slider['status'] == 'unpublished') echo 'checked="checked"'; ?>>
                                    <div class="control-indicator"></div>
                                </label>
                            </li>
                        </ul>
