...
class News
{
    ...
    public function all()
    {
        ...
        $query = 
        "SELECT n.news_id, n.title, n.highlight, n.status,u1.name as created_by, n.created_at, n.updated_at, u2.name as updated_by
    ...
    {
        $query = 
        "SELECT n.news_id, n.title, n.highlight, n.body, n.status,u.name as created_by, n.created_at, n.updated_at
